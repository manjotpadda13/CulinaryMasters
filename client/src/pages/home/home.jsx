...
function Home() {
  ...
  const [dishThreeImage, setdishThreeImage] = useState(
    "https://picsum.photos/200"
  );
  const [dishFourName, setdishFourName] = useState("");
  const [dishFourImage, setdishFourImage] = useState(
    "https://picsum.photos/200"
  );
  ...
  let [rowThreeDishThreeIngredients, setrowThreeDishThreeIngredients] =
    useState();
  let [rowThreeDishFourIngredients, setrowThreeDishFourIngredients] =
    useState();
  ...
  const handleSearchClick = () => {
    ...
    Axios.get(
      `https://www.themealdb.com/api/json/v1/${ApiKey}/search.php?s=${searchInput}`
    )
      .then((res) => {
        ...
        if (res.data.meals[0]) {
          ...
          var strIngredientKeys = keys.filter((key) =>
  ...
  // store image state
  const [rowTwoDishOneImage, setrowTwoDishOneImage] = useState(
    "https://picsum.photos/200"
  );
  const [rowTwoDishTwoImage, setrowTwoDishTwoImage] = useState(
    "https://picsum.photos/200"
  );
  const [rowTwoDishThreeImage, setrowTwoDishThreeImage] = useState(
    "https://picsum.photos/200"
  );
  const [rowTwoDishFourImage, setrowTwoDishFourImage] = useState(
    "https://picsum.photos/200"
  );
  ...
  // Dessert Ingredients
  Axios.get(
    `https://www.themealdb.com/api/json/v1/1/search.php?s=Banana%20Pancakes`
  )
    .then((res) => {
      if (res.data.meals && res.data.meals.length > 0) {
        ...
        for (const keytwo in meal) {
          // Check if the key starts with "strIngredient" and if the value is not null or empty
          if (
            keytwo.startsWith("strInstructions") &&
            meal[keytwo] &&
            meal[keytwo].trim() !== ""
          ) {
  ...
  Axios.get(
    `https://www.themealdb.com/api/json/v1/1/search.php?s=Canadian%20Butter%20Tarts`
  )
    .then((res) => {
      if (res.data.meals && res.data.meals.length > 0) {
        var meal = res.data.meals[0]; // Access the first meal object
  ...
  Axios.get(
    `https://www.themealdb.com/api/json/v1/1/search.php?s=Chocolate%20Souffle`
  )
    .then((res) => {
      if (res.data.meals && res.data.meals.length > 0) {
        var meal = res.data.meals[0]; // Access the first meal object
  ...
  // // store image state
  const [rowThreeDishOneImage, setrowThreeDishOneImage] = useState(
    "https://picsum.photos/200"
  );
  const [rowThreeDishTwoImage, setrowThreeDishTwoImage] = useState(
    "https://picsum.photos/200"
  );
  const [rowThreeDishThreeImage, setrowThreeDishThreeImage] = useState(
    "https://picsum.photos/200"
  );
  const [rowThreeDishFourImage, setrowThreeDishFourImage] = useState(
    "https://picsum.photos/200"
  );
  // Seafood Section
  Axios.get(
  ...
  Axios.get(
    `https://www.themealdb.com/api/json/v1/1/search.php?s=Salmon%20Avocado%20Salad`
  )
    .then((res) => {
      if (res.data.meals && res.data.meals.length > 0) {
        var meal = res.data.meals[0]; // Access the first meal object
  ...
  Axios.get(
    `https://www.themealdb.com/api/json/v1/1/search.php?s=Tuna%20and%20Egg%20Briks`
  )
    .then((res) => {
      if (res.data.meals && res.data.meals.length > 0) {
        var meal = res.data.meals[0]; // Access the first meal object
  ...
  Axios.get(
    `https://www.themealdb.com/api/json/v1/1/search.php?s=Spring%20onion%20and%20prawn%20empanadas`
  )
    .then((res) => {
      if (res.data.meals && res.data.meals.length > 0) {
        var meal = res.data.meals[0]; // Access the first meal object
  ...
  return (
    <>
      ...
      <div className="row-two">
        ...
        <div className="card">
          <img
            src={rowTwoDishThreeImage}
            alt="Dish"
            style={{ width: "100%" }}
          />
          <div className="container">
            <h4>
              <b>{rowTwoDishThreeName}</b>
            </h4>
            <p>Ingredients:</p>
            <ul>
      ...
      <div className="row-three">
        ...
        <div className="card">
          <img
            src={rowThreeDishOneImage}
            alt="Dish"
            style={{ width: "100%" }}
          />
          <div className="container">
            <h4>
              <b>{rowThreeDishOneName}</b>
            </h4>
            <p>Ingredients:</p>
            <ul>
        ...
        <div className="card">
          <img
            src={rowThreeDishTwoImage}
            alt="Dish"
            style={{ width: "100%" }}
          />
          <div className="container">
            <h4>
              <b>{rowThreeDishTwoName}</b>
            </h4>
            <p>Ingredients:</p>
            <ul>
        ...
        <div className="card">
          <img
            src={rowThreeDishThreeImage}
            alt="Dish"
            style={{ width: "100%" }}
          />
          <div className="container">
            <h4>
              <b>{rowThreeDishThreeName}</b>
            </h4>
            <p>Ingredients:</p>
            <ul>
        ...
        <div className="card">
          <img
            src={rowThreeDishFourImage}
            alt="Dish"
            style={{ width: "100%" }}
          />
          <div className="container">
            <h4>
              <b>{rowThreeDishFourName}</b>
            </h4>
            <p>Ingredients:</p>
            <ul>
